 ...
 * @author Hp
 */
public class up_pat extends javax.swing.JFrame {

    /**
     * Creates new form up_pat
     */
    String val[];

    public up_pat() throws IOException {
        initComponents();
        addholder(id);
        Pname.setVisible(false);
        pass.setVisible(false);
        gard_name.setVisible(false);
        h_no.setVisible(false);
        st_col.setVisible(false);
        city.setVisible(false);
        ph_no.setVisible(false);
        male.setVisible(false);
        female.setVisible(false);
        bl_grp.setVisible(false);
    ...
    public void setdocs() throws FileNotFoundException, IOException {
        String line;
    ...
    private void initComponents() {
        ...
        getContentPane().add(Pname, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 110, 220, 50));
        ...
        getContentPane().add(gard_name, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 170, 220, 50));
        ...
        getContentPane().add(h_no, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 280, 220, 50));
        ...
        getContentPane().add(st_col, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 340, 220, 50));
        ...
        getContentPane().add(city, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 400, 220, 50));
        ...
        getContentPane().add(pass, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 110, 220, 50));
        ...
        getContentPane().add(ph_no, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 170, 220, 50));
        ...
        male.setText("Male");
        male.setOpaque(true);
        getContentPane().add(male, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 260, -1, -1));
        ...
        getContentPane().add(female, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 300, -1, -1));
        ...
        getContentPane().add(bl_grp, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 360, 160, 30));
        ...
        doc_name.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Doctor Name", "*doc deleted* " }));
        doc_name.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        getContentPane().add(doc_name, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 320, 280, 40));
        ...
        getContentPane().add(prob, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 110, 300, 120));

        del.setBackground(new java.awt.Color(29, 164, 196));
        ...
        getContentPane().add(del, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 430, 160, 40));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 30, 100, 40));

        update.setBackground(new java.awt.Color(29, 164, 196));
        ...
        getContentPane().add(update, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 430, 160, 40));

        del1.setBackground(new java.awt.Color(29, 164, 196));
        del1.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        ...
        getContentPane().add(del1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 470, 100, 40));

        jLabel1.setBackground(new java.awt.Color(29, 164, 196));
    ...
    private void delMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_delMouseClicked
        ...
        try {
            ...
            File oldfile = new File("patient.csv");
            ...
            System.out.println("pat deleted");
        ...
        try {
            ...
            newfile.renameTo(dump);
            System.out.println("pres deleted");
            
            this.setVisible(false);
            new update(this, rootPaneCheckingEnabled, "PATIENT DELETED", WIDTH).setVisible(true);
        ...
        try {
            ...
            while ((line = br.readLine()) != null) {
                ...
                if (values[0].equals(id.getText())) {
                    ...
                    doc_name.getModel().setSelectedItem(val[3]);

                    prob.setVisible(true);
                    prob.setText(val[4]);

                    bl_grp.setVisible(true);
                    bl_grp.setSelectedItem(val[5]);
                    ...
                    gard_name.setVisible(true);
                    gard_name.setText(val[7]);

                    ph_no.setVisible(true);
                    ph_no.setText(val[8]);

                    String add[] = val[9].split(" ");
                    h_no.setVisible(true);
                    h_no.setText(add[0]);
                    
                    st_col.setVisible(true);
                    st_col.setText(add[1]);
    ...
    public boolean ok() {
        ...
        if (doc_name.getSelectedItem().equals("Doctor Name") || doc_name.getSelectedItem().equals("*doc deleted* ")) {
            ...
            try {
                ...
                while ((line = br.readLine()) != null) {
                    ...
                    if (values[0].equals(id.getText())) {
                        ...
                        String dname = name[0];
                        pw.println(id.getText() + "," + Pname.getText() + "," + pass.getText() + "," + dname + "," + prob.getText() + ","
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(up_pat.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    Logger.getLogger(up_pat.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
